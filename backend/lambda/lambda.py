...
IDLE_CHECKS_BEFORE_ACTION = 3  # Number of consecutive idle checks before action
...
NAT_GATEWAY_IDLE_CHECKS = 3           # Consecutive idle checks before deletion
...
RDS_IDLE_CHECKS = 3                   # Consecutive checks before action (3 = 3 days with daily checks)
...
S3_EMPTY_BUCKET_CHECKS = 3                     # Consecutive empty checks before deletion
...
EBS_UNATTACHED_CHECKS = 3                 # Consecutive checks before deletion (3 = 3 days)
...
LB_IDLE_CHECKS = 3                        # Consecutive idle checks before deletion
...
VPC_IDLE_CHECKS = 3                       # Consecutive idle checks before deletion
